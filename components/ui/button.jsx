  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        order:"text-white active:bg-white active:text-black bg-stone-900 text-white border border-stone-700",
        ...
        hero_button:"bg-black border text-white text-lg active:bg-white active:text-black active:font-bold font-bold",
      },
      size: {
        default: "h-9 px-4 py-2",
        quantity:" h-8 rounded-md px-3 text-sm",
        sm: "h-8 rounded-md px-3 text-xs",
        addOptions:"h-10 rounded-md  px-6 text-sm",
        lg: "h-10 rounded-md  ",
        icon: "h-9 w-9",
        subscribe: "h-12 px-4 py-6 rounded-lg",
        address:"rounded-lg h-10 p-6 w-full",
        order:"rounded-lg h-10 p-6 w-full",
